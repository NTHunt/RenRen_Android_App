...
public class StateDetailsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.details_statenews);
		...
		ImageView userPhoto=(ImageView)findViewById(R.id.iv_user_image_statenews_details);
		TextView userName=(TextView)findViewById(R.id.tv_nickname_statenews_details);
		TextView content=(TextView)findViewById(R.id.tv_content_statenews_details);
		TextView time=(TextView)findViewById(R.id.tv_published_statenews_details);
		TextView source=(TextView)findViewById(R.id.tv_source_statenews_details);
		Button comment=(Button)findViewById(R.id.button_state_comment);
        ...
        mImageLoader.LoadingImage(userPhoto, bundle.getString("photo"));
        
        comment.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View v) {
				EditText comment_text=(EditText)StateDetailsActivity.this.findViewById(R.id.editText_state_comment);
				if(comment_text.getTextSize()>0){
			    	new AlertDialog.Builder(StateDetailsActivity.this).setTitle("提示：暂时无法提交评论")
					...
					.setPositiveButton("同情", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							Toast.makeText(StateDetailsActivity.this, "谢谢，嘿嘿", Toast.LENGTH_SHORT).show();
						}
					})
					.setNegativeButton("鄙视", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							// TODO Auto-generated method stub
							Toast.makeText(StateDetailsActivity.this, "没关系，我叫小强！", Toast.LENGTH_SHORT).show();
						}
					})
					.show();
					...
					RenRenStateDoCommentAsyncTask mRenRenStateDoCommentAsyncTask=new RenRenStateDoCommentAsyncTask();
					mRenRenStateDoCommentAsyncTask.execute(params);*/
				}else{
					Toast.makeText(StateDetailsActivity.this, "请输入评论内容", Toast.LENGTH_SHORT).show();
				}
			}
		});
	}
	...
	private class RenRenStateDoCommentAsyncTask extends AsyncTask<String, Integer, String> {	  
	    ...
	    protected String doInBackground(String... params) {
			...
			try{
	            ...
	            postParams.add(new BasicNameValuePair("commentType", "STATUS"));
	            ...
	            //obj.put("content", params[3]);  
	           // obj.put("targetUserId", "0");  
	            //obj.put("commentType","STATUS");  
	            //obj.put("entryOwnerId",  params[2]);  
	           // obj.put("entryId", params[1]);  
	           // postURL.setEntity(new StringEntity(obj.toString()));     
	    ...
	    protected void onPostExecute(String resultJson) { 
			...
			{
				Toast.makeText(StateDetailsActivity.this, "评论成功！", Toast.LENGTH_SHORT).show();
				EditText comment_text=(EditText)StateDetailsActivity.this.findViewById(R.id.editText_state_comment);
				comment_text.setText("");

				LinearLayout commentLayout=(LinearLayout)StateDetailsActivity.this.findViewById(R.id.ll_comments_content_statenews_details);
				commentLayout.setVisibility(LinearLayout.VISIBLE);
				
	            TextView tvCount = new TextView(StateDetailsActivity.this);  
				...
				try{
					...
					if(!json.isNull("response")){
		                ...
		                TextView tvContent = new TextView(StateDetailsActivity.this);
		                ...
		                TextView tvTime = new TextView(StateDetailsActivity.this); 
